...
/***/ "(rsc)/./src/app/api/bookings/unavailable-dates/[hallOwnerId]/route.ts":
/*!***********************************************************************!*\
  !*** ./src/app/api/bookings/unavailable-dates/[hallOwnerId]/route.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_firebase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/firebase */ \"(rsc)/./src/lib/firebase.ts\");\n/* harmony import */ var firebase_firestore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! firebase/firestore */ \"(rsc)/./node_modules/firebase/firestore/dist/index.mjs\");\n\n\n\nasync function GET(request, context) {\n    try {\n        const { hallOwnerId } = await context.params;\n        const { searchParams } = new URL(request.url);\n        const resourceId = searchParams.get('resourceId');\n        const startDate = searchParams.get('startDate');\n        const endDate = searchParams.get('endDate');\n        const userDocRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.doc)(_lib_firebase__WEBPACK_IMPORTED_MODULE_1__.db, 'users', hallOwnerId);\n        const userDoc = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getDoc)(userDocRef);\n        if (!userDoc.exists() || userDoc.data()?.role !== 'hall_owner') {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                message: 'Hall owner not found'\n            }, {\n                status: 404\n            });\n        }\n        const bookingsQuery = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.query)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.collection)(_lib_firebase__WEBPACK_IMPORTED_MODULE_1__.db, 'bookings'), (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.where)('hallOwnerId', '==', hallOwnerId));\n        const bookingsSnapshot = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_2__.getDocs)(bookingsQuery);\n        const filteredBookings = bookingsSnapshot.docs.filter((d)=>{\n            const b = d.data();\n            if (![\n                'pending',\n                'confirmed'\n            ].includes(b.status)) return false;\n            if (resourceId && b.selectedHall !== resourceId) return false;\n            if (startDate && b.bookingDate < startDate) return false;\n            if (endDate && b.bookingDate > endDate) return false;\n            return true;\n        });\n        const unavailableDates = {};\n        filteredBookings.forEach((d)=>{\n            const b = d.data();\n            const bookingDate = b.bookingDate;\n            const selectedHall = b.selectedHall;\n            if (!bookingDate || !selectedHall) return;\n            if (!unavailableDates[bookingDate]) unavailableDates[bookingDate] = {};\n            if (!unavailableDates[bookingDate][selectedHall]) unavailableDates[bookingDate][selectedHall] = [];\n            unavailableDates[bookingDate][selectedHall].push({\n                bookingId: d.id,\n                startTime: b.startTime || 'N/A',\n                endTime: b.endTime || 'N/A',\n                customerName: b.customerName || 'Unknown',\n                eventType: b.eventType || 'Unknown',\n                status: b.status || 'Unknown'\n            });\n        });\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            unavailableDates,\n            totalBookings: filteredBookings.length,\n            message: 'Successfully fetched unavailable dates'\n        });\n    } catch (error) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            message: error instanceof Error ? error.message : 'Internal server error'\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./src/app/api/bookings/unavailable-dates/[hallOwnerId]/route.ts\n");
